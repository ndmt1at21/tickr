module github.com/ndmt1at21/tickr/benchmarks

go 1.25.7

// Bench against the local tickr source, not a published version.
...
require (
	...
	// Postgres adapters (pgx native + database/sql via pgx stdlib subpackage)
	github.com/jackc/pgx/v5 v5.9.2
	github.com/ndmt1at21/tickr v0.0.0-00010101000000-000000000000
